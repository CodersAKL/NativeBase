...
class Fab extends Component<FabProps, FabState> {
  ...
  fabOtherBtns(direction, i) {
    ...
    if (direction === DIRECTION.UP) {
      return {
        top: undefined,
        bottom: active === false ? (Platform.OS === PLATFORM.IOS ? 50 : 5) : i * 50 + 65,
        left: 8,
        right: 0
      };
      ...
      return {
        top: 8,
        bottom: 0,
        left: active === false ? (Platform.OS === PLATFORM.IOS ? 8 : 8) : -(i * 50 + variables.fabWidth + 2),
        right: 0
      };
    } else if (direction === DIRECTION.DOWN) {
      return {
        top: active === false ? (Platform.OS === PLATFORM.IOS ? 50 : 8) : i * 50 + 73,
        bottom: 0,
        left: 8,
        right: 0
      };
      ...
      return {
        top: 8,
        bottom: 0,
        left: active === false ? (Platform.OS === PLATFORM.IOS ? 50 : 8) : i * 50 + 73,
        right: 0
      };
    }
  ...
  render() {
    ...
    return (
      <Animated.View style={this.getContainerStyle()}>
        {this.renderButtons()}
        {Platform.OS === PLATFORM.IOS || variables.androidRipple === false || Platform.Version <= 21 ? (
