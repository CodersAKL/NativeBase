...
import { ActionSheetIOS, Dimensions, FlatList, Modal, Platform, TouchableOpacity, StyleSheet } from 'react-native';
...
type ActionSheetContainerState = {
  title: any;
  message: any;
      ...
      >
        ...
        >
          <TouchableOpacity activeOpacity={1} style={styles.innerTouchable}>
            {this.state.title ? <Text style={styles.touchableText}>{this.state.title}</Text> : null}
            <FlatList
