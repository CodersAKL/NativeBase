...
import { View, Animated, StyleSheet, ScrollView, Platform, Dimensions, ViewStyle } from 'react-native';
...
export class ScrollableTabBar extends React.Component<ScrollableTabBarProps, ScrollableTabBarState> {
  ...
  UNSAFE_componentWillReceiveProps(nextProps) {
    ...
    if (!isEqual(this.props.tabs, nextProps.tabs) && this.state._containerWidth) {
      this.setState({ _containerWidth: undefined });
    }
  }
...
export const ScrollableTab = connectStyle('NativeBase.ScrollableTab', {}, mapPropsToStyleNames)(ScrollableTabBar);
