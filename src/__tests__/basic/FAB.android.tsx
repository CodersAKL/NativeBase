...
it('renders single FAB inactive', () => {
  const tree = renderer
    .create(
      <View style={{ flex: 1 }}>
        <Fab active={false} direction="up" style={{ backgroundColor: '#5067FF' }} position="bottomRight">
...
it('renders single FAB active', () => {
  const tree = renderer
    .create(
      <View style={{ flex: 1 }}>
        <Fab active={true} direction="up" style={{ backgroundColor: '#5067FF' }} position="bottomRight">
          <IconNB name="md-share" />
          <Button style={{ backgroundColor: '#34A34F' }}>
            <IconNB name="logo-whatsapp" />
          </Button>
